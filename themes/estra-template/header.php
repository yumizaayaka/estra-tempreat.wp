...
<head>
    ...
    <link rel="stylesheet" href="<?php get_theme_file_uri( '/css/reset.css' );?>"
    <link rel="stylesheet" href="<?php get_theme_file_uri( '/css/common.css' );?>"
    <link rel="stylesheet" href="<?php get_theme_file_uri( '/style.css' ); ?>"
